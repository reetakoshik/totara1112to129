...
/**
 * Course progress report block installation.
 */
function xmldb_block_course_progress_report_install() {
    global $DB;

    $name = 'course_progress_report';
    ...
    if ($during_migration) {
        ...
        $DB->set_field('block', 'visible', 0, array('name' => $name));
    }
}
