...
$PAGE->set_url('/blocks/policyblock/accept.php');
...
if (!$haspermissionagreedocs) {
    ...
    redirect(new moodle_url('/blocks/policyblock/index.php'));
} else if ($cancel) {
    redirect(new moodle_url('/blocks/policyblock/index.php'));
} else {
    ...
    //die('herer123yoo');
    api::accept_policies($agreedocs,  $behalfid, null,null);
    api::decline_policies($declinedocs, $behalfid, null, null);
