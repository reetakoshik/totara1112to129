...
/**
 * Class request_rejected
 */
final class request_rejected extends \core\event\base {
    /**
    ...
    public function get_description() {
        ...
        return "$username ($email) rejected for system access";
    }
    ...
    public static function get_name() {
        return get_string('eventrequestrejected', 'auth_approved');
    }
