...
/**
 * Confirmation of bulk approval.
 */
final class bulk_approve extends \totara_form\form {
    public function definition() {
        $parameters = $this->get_parameters();
        $bulkcount = count($parameters['requestids']);

        $this->model->add(new static_html('sure', '', get_string('bulkactionapproveconfirm', 'auth_approved', $bulkcount)));
