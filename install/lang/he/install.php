...
$string['clialreadyconfigured'] = 'קובץ config.php כבר קיים, אנא השתמש ב. admin/cli/install_database.php אם ברצונך להתקין אתר זה.';
$string['clialreadyinstalled'] = 'קובץ ה-config.php קיים כבר, אנא השתמש ב- admin/cli/install_database.php אם ברצונך לשדרג את האתר שלך.';
$string['cliinstallheader'] = 'תוכנית התקנת Totara {$a} בשורת הפקודה';
$string['configfilenotwritten'] = 'תסריט (script) ההתקנה לא הצליח ליצור באופן אוטומטי את קובץ config.php המכיל את בחירת ההגדרות שלך, ייתכן שהדבר קרה בגלל שספריית ה-Totara שלך איננה ניתנת לכתיבה. תוכל באופן ידני להעתיק את הקוד הבא לתוך קובץ config.php בספריית האם של Totara.';
$string['configfilewritten'] = 'קובץ config.php נוצר בהצלחה';
$string['configurationcompletesub'] = 'Totara ניסה לשמור את הגדרות התצורה שלך בקובץ בספריית ה-root של התקנת ה-Totara.';
$string['databasehost'] = 'מחשב מארח של מסד הנתונים (DB host)';
...
יפעל דהיינו:';
$string['welcomep40'] = 'החבילה כוללת בנוסף <strong>Totara {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep70'] = 'לחצו "המשך" למטה כדי להמשיך עם הגדרת ה-<strong>Totara</strong>';
