...
$string['maturitycorewarning'] = 'גרסת ה-Totara אותה הינך עומד להתקין או לשדרג מכילה קוד פיתוח "{$a}"  לא יציב אשר לא מותאם לשימוש ברוב האתרים הרשמיים. אם זהו אינו הדבר שרצית לעשות, אנא וודא כי הינך מעדכן מענף STABLE  של קוד ה-Totara.
למידע נוסף ניתן לעיין ב-Totara Docs.';
$string['releasenoteslink'] = 'צפו בדוח עדכוני גרסאות Totara, אנא בקרו ב <a target="new" href="{$a}"> שחרור גרסה </a>';
$string['upgradekeyset'] = 'מפתח לשדורג (השאר ריק על מנת לא לקבוע מפתח כזה)';
