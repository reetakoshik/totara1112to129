...
$string['cannotcreatedboninstall'] = '<p>לא ניתן ליצור בסיס נתונים.</p>
<p>בסיס הנתונים שהוגדר לא קיים והמשתמש שציינתם אינו בעל הרשאות מספקות ליצירת בסיס נתונים.</p>
<p>מנהל המערכת צריך לוודא תקינות הגדרות בסיס הנתונים.</p>';
...
$string['dmlexceptiononinstall'] = '<p>התרחשה שגיאת בסיס נתונים [{$a->errorcode}].<br />{$a->debuginfo}</p>';
