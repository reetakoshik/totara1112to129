...
$string['availablelangs'] = 'Beschikbare taalbestanden';
...
$string['configfilenotwritten'] = 'Het installatiescript kon het bestand config.php met jouw gekozen instellingen niet automatisch aanmaken.  Kopieer de volgende code in een bestand dat je config.php noemt en plaats dat in de rootmap van Totara.';
$string['configfilewritten'] = 'Het maken van config.php is gelukt';
$string['configurationcompletesub'] = 'Totara probeerde je configuratie te bewaren in een bestand in de root van je installatie.';
...
$string['environmentsub2'] = 'Elke Totaraversie vraagt een minimum PHP-versie en een aantal vereiste PHP-extenties.
...
$string['pathssubdataroot'] = 'Je hebt een plaats nodig waar Totara geüploade bestanden kan bewaren. Deze map moet leesbaar en BESCHRIJFBAAR zijn door de webserver gebruiker (gewoonlijk \'nobody\', \'apache\' of www-data\') en mag niet rechtstreeks toegankelijk zijn vanaf het internet.';
$string['pathssubdirroot'] = 'Volledig pad naar de Totara-installatie.';
$string['pathssubwwwroot'] = 'Volledig webadres waarlangs de toegang naar Totara zal gebeuren. Het is niet mogelijk toegang tot Totara te krijgen via meerdere adressen. Als je site meerdere publieke adressen heeft, dan zul je permanente verwijzingen moeten opzetten voor al die adressen, behalve voor wat je hier invult. Als je site zowel van het internet als van een intranet toegankelijk is, zet dat het internetadres hier en wijzig je DNS-instellingen zodanig dat intranetgebruikers dit publieke adres ook gebruiken.
...
$string['phpversionhelp'] = '<p>Totara heeft minstens PHP-versie 5.6.5 of 7.1 nodig (7.0.x heeft een aantal beperkingen).</p>
