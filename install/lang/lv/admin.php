...
$string['clitypevaluedefault'] = 'veida vērtība, nospiediet Enter, lai izmantotu noklusējuma vērtību ({$a})';
$string['cliunknowoption'] = 'Neatpazītas opcijas:
  {$a}
Lūdzu, izmantojiet opciju --palīdzība.';
$string['cliyesnoprompt'] = 'ierakstiet y (nozīmē yes — jā) vai n (nozīmē no — nē)';
