...
$string['environmentsub2'] = 'Každé vydání Totara vyžaduje určitou minimální verzi PHP a několik povinných rozšíření PHP. Plná kontrola prostředí se provádí před každým instalací a upgrade. Prosím, kontaktujte správce serveru, pokud nevíte, jak nainstalovat novou verzi, nebo povolit rozšíření PHP.';
...
Totara si tak bude sám moci nastavit potřebný limit.</li>
...
$string['pathssubdirroot'] = '<p>Absolutní cesta k adresáři s instalací Totara.</p>';
...
$string['phpversionhelp'] = '<p>Totara vyžaduje PHP alespoň verze 5.6.5 PHP nebo 7.1 (7.0.x má určitá omezení jádra).</p>
...
$string['welcomep30'] = 'Tato verze <strong>{$a->installername}</strong> obsahuje aplikace k vytvoření prostředí, ve kterém bude provozován váš <strong>Totara</strong>. Jmenovitě se jedná o:';
