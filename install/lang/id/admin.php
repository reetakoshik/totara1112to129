...
$string['environmentrequireinstall'] = 'harus diinstal dan dipasang';
$string['environmentrequireversion'] = 'versi {$a->needed} diperlukan dan Anda sedang menjalankan {$a->current}';
$string['upgradekeyset'] = 'Tombol upgrade (kosongkan sampai tidak disetel)';
