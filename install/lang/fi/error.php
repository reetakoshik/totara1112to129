...
$string['cannotcreatedboninstall'] = '<p>Tietokantaa ei voida luoda.</p>
<p>Kyseistä tietokantaa ei ole olemassa ja kyseisellä käyttäjällä ei ole valtuuksia luoda tietokantaa.</p>
<p>Sivuston hallinnoijan tulee varmistaa tietokannan konfiguraatio.</p>';
...
$string['dmlexceptiononinstall'] = '<p>Tietokantavirhe [{$a->errorcode}].<br />{$a->debuginfo}</p>';
