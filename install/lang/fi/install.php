...
$string['cliinstallheader'] = 'Totara {$a} komentoriviasennusohjelma';
...
<p>Tämä saattaa aiheuttaa Totara muistiongelmia myöhemmin, varsinkin jos sinulla on paljon mahdollisia moduuleita ja/tai paljon käyttäjiä.</p>
...
Tämä sallii Totara asettaa muistirajan itse.</li>
...
$string['pathssubadmindir'] = 'Jotkut sivustot käyttävät /admin URL-osoitetta hallintapaneelille tai vastaavalle. Tämä on valitettavasti ristiriidassa Totara normaalin admin-sivun sijainnin kanssa.
Voit korjata tämän nimeämällä asennuksesi admin-hakemiston uudelleen, antamalla uuden nimen tähän. Esimerkiksi: <em>moodleadmin</em>. Tämä korjaa admin-linkit Totara.';
...
$string['pathssubwwwroot'] = 'Totara koko verkko-osoite.
Totara ei ole mahdollista päästä käyttäen useita osoitteita.
...
$string['welcomep40'] = 'Tämä paketti sisältää myös <strong>Totara {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Seuraavat sivut opastavat sinua helposti seurattavien vaiheiden läpi <strong>Totara</strong> konfiguroinnissa koneellesi. Voit hyväksyä oletusasetukset tai vaihtoehtoisesti muuttaa niitä tarvitsemallasi tavalla.';
