...
$string['clialreadyconfigured'] = 'Konfigurationsfilen  config.php finns redan. Använd admin/cli/install_database.php för att installera Totara på denna webbplats.';
$string['clialreadyinstalled'] = 'Konfigurationsfilen config.php finns redan, använd admin/cli/install_database.php om du vill uppgradera Totara för denna webbplats.';
$string['cliinstallheader'] = 'Installationsprogram av typ kommandorad {$a} för Totara';
$string['configfilenotwritten'] = 'Skriptet för installationen kunde inte automatiskt skapa en config.php som innehåller de inställningar som Du har valt. Var snäll och kopiera den följande koden till en fil med namnet config.php i Totaras "root"-katalog.';
$string['configfilewritten'] = 'config.php har skapats framgångsrikt';
$string['configurationcompletesub'] = 'Totara gjorde ett försök att spara Din konfiguration i en fil i roten (root) på Din installation av Totara.';
...
$string['datarootpermission'] = 'Rättighet för datakataloger';
...
$string['pathssubadmindir'] = 'Ett fåtal webbvärdare använder /admin som en speciell URL där du kan få tillgång till kontrollpanel eller liknande. Tyvärr så innebär detta en konflikt med standardplatsen för Totaras adminsidor. Du kan lösa detta genom att byta namn på admin-katalogen på din installation, och ange ett nytt namn där. Till exempel: <em>totaraadmin</em>. Detta kommer att fixa admin-länkar i Totara.';
