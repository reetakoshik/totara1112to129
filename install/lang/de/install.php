...
$string['clialreadyconfigured'] = 'Die Datei config.php existiert bereits. Bitte benutzen Sie admin/cli/install_database.php, wenn Sie Totara installieren möchten.';
$string['clialreadyinstalled'] = 'Die Datei config.php existiert bereits. Bitte benutzen Sie admin/cli/upgrade.php, wenn Sie Totara aktualisieren möchten.';
$string['cliinstallheader'] = 'Installation von Totara {$a} über die Befehlszeile';
$string['configfilewritten'] = 'Die Datei config.php wurde erfolgreich erstellt';
$string['databasehost'] = 'Datenbank-Host';
