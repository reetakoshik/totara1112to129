...
$string['clitypevaluedefault'] = 'ادخل القيم أو اضغط (Enter) لإستخدام القيم الأفتراضية  ({$a})';
$string['cliunknowoption'] = 'خيارات غير معروفة
{$a}
الرجاء استخدام خيار المساعدة';
$string['cliyesnoprompt'] = 'ادخل (Y) تعني نعم أو (N) تعني لا';
...
$string['upgradekeyset'] = 'مفتاح الترقية (اتركه فارغا لعدم تعيينه)';
