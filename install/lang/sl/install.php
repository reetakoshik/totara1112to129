...
$string['clialreadyconfigured'] = 'Konfiguracijska datoteka config.php že obstaja. Prosimo, uporabite admin/cli/install_database.php za namestitev Totare za to spletno mesto.';
...
$string['cliinstallheader'] = 'Totara {$a} namestitveni program z ukazno vrstico';
...
<p>To lahko povzroči, da bo imel Totara pozneje težave s pomnilnikom. Še posebej,
...
<li>Če lahko, ponovno prevedite PHP z <i>--enable-memory-limit</i>.
    To bo omogočilo, da bo Totara sam nastavil omejitev pomnilnik zase.</li>
...
<li>Na nekaterih strežnikih PHP lahko ustvarite datoteko .htaccess v imeniku Totara,
...
$string['pathssubdataroot'] = 'Potrebujete prostor, kamor bo Totara shranjeval naložene datoteke. Ta mapa naj ima omogočeno branje IN PISANJE s strani uporabnika spletnega strežnika (po navadi \'brez\' ali \'apache\'), ampak ne sme biti dostopno neposredno preko spleta. Namestitveni program jo bo poskušal ustvariti, če že ne obstaja.';
$string['pathssubdirroot'] = '<p>Polna pot do mape s kodo Totara.</p>';
$string['pathssubwwwroot'] = 'Polni spletni naslov kjer bo Totara dostopan. Dostop do Moodla z uporabo več naslovov ni mogoč. Če ima vaša stran več javnih naslovov, morate nastaviti trajne preusmeritve na vse naslove razen tega. Če je vaša stran dosropana preko interneta in omrežja, uporabite tukaj javne naslove in nastaviet DNS tako, da lahko uporabniki znotraj omrežja uporabljajo tudi javne naslove. Če naslovi niso pravilni prosimo spremenite URL v vašem brskalniku in ponovno poženite namestitev z drugo vrednostjo.';
...
$string['phpversionhelp'] = '<p>Totara zahteva različico PHP vsaj 4.3.0 ali 5.1.0 (5.0.x ima vrsto znanih težav).</p>
...
$string['welcomep30'] = 'Ta različica <strong>{$a->installername}</strong> vključuje aplikacije
    za ustvarjanje okolja v katerem bo deloval <strong>Totara</strong> in sicer:';
$string['welcomep40'] = 'Ta paket vključuje tudi <strong>Totara {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep60'] = 'Naslednje strani vas bodo popeljale skozi nekaj enostavno sledljivih korakov za
    konfiguracijo in nastavitev <strong>Totara</strong>  na vašem računalniku. Sprejmete lahko privzete
    nastavitve ali jih, če tako želite, spremenite, da bodo ustrezale vašim potrebam.';
$string['welcomep70'] = 'Kliknite spodnji gumb "Naprej" za nadaljevanje nastavitve <strong>Totara</strong>.';
