...
$string['cannotcreatedboninstall'] = '<p>Nije bilo moguće stvoriti bazu podataka.</p>
<p>Navedena baza podataka ne postoji i dani korisnik nema dopuštenje za izradu baze podataka.</p>.</p>
<p>Administrator web-mjesta trebao bi potvrditi konfiguraciju baze podataka.</p>';
...
$string['dmlexceptiononinstall'] = '<p>Došlo je do pogreške baze podataka [{$a->errorcode}].<br/> {$a->debuginfo} </p>';
