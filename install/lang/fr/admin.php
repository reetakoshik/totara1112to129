...
$string['maturitycorewarning'] = 'Vous êtes sur le point d\'installer une version ou de mettre à jour Totara vers un version marquée comme « {$a} », qui n\'est pas considérée comme prête pour la production. Veuillez vous assurer que cette action est intentionnelle et que vous utilisez la version voulue de Totara.';
$string['releasenoteslink'] = 'Pour des informations sur cette version de Totara, veuillez consulter les <a target="_blank" href="{$a}">Notes de mise à jour</a> en ligne.';
