...
$string['clialreadyconfigured'] = 'Το αρχείο ρυθμίσεων config.php υπάρχει ήδη. Χρησιμοποιήστε το admin / cli / install_database.php για να εγκαταστήσετε το Totara για αυτή τη σελίδα.';
$string['clialreadyinstalled'] = 'Το αρχείο ρυθμίσεων config.php υπάρχει ήδη. Χρησιμοποιήστε το admin / cli / install_database.php για να αναβαθμίσετε το Totara για αυτή τη σελίδα.';
...
$string['datarootpermission'] = 'Άδεια καταλόγων δεδομένων';
$string['dbprefix'] = 'Πρόθεμα πινάκων';
$string['dirroot'] = 'Φάκελος ΠΗΛΕΑΣ';
$string['environmenthead'] = 'Έλεγχος περιβάλλοντος...';
$string['environmentsub2'] = 'Κάθε έκδοση Totara έχει κάποια ελάχιστη απαίτηση σχετικά με την έκδοση της PHP και ενός αριθμού από αναγκαίες επεκτάσεις PHP.
...
Αυτό θα επιτρέψει στο Totara να ορίσει μόνο του το memory limit.</li>
...
σε έναν πίνακα ελέγχου ή κάτι παρόμοιο.  Δυστυχώς αυτό έρχεται σε σύγκρουση με την πρότυπη τοποθεσία για τις σελίδες διαχείρισης του Totara.  Μπορείτε να το διορθώσετε αυτό
μετονομάζοντας τον φάκελο admin στην εγκατάσταση σας, και βάζοντας ένα νέο όνομα εδώ.  Για παράδειγμα: <em>moodleadmin</em>. Αυτό θα διορθώσει τους συνδέσμους στο Totara.';
$string['pathssubdataroot'] = 'Χρειάζεστε ένα μέρος όπου το Totara μπορεί να αποθηκεύει τα ανεβασμένα αρχεία. Αυτός ο φάκελος θα πρέπει να μπορεί να διαβάζεται και να εγγράφεται από τον χρήστη του εξυπηρετητή ιστού
...
Δεν είναι δυνατόν να έχετε πρόβαση στο Totara χρησιμοποιώντας πολλαπλές διευθύνσεις.
...
$string['welcomep40'] = 'Το πακέτο περιλαμβάνει επίσης <strong>Totara {$a->moodlerelease} ({$a->moodleversion})</strong>.';
...
$string['welcomep70'] = 'Πατήστε το κουμπί "Συνέχεια" για να συνεχίσετε με την εκγατάσταση του <strong>Totara</strong>.';
