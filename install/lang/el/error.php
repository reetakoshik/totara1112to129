...
$string['cannotcreatedboninstall'] = '<p> Δεν είναι δυνατή η δημιουργία της βάσης δεδομένων. </p><p> Η καθορισμένη βάση δεδομένων δεν υπάρχει και ο δεδομένος χρήστης δεν έχει άδεια για τη δημιουργία της βάσης δεδομένων. </p><p> Ο διαχειριστής του site θα πρέπει να ελέγξει τη διαμόρφωση της βάσης δεδομένων. </p>';
...
$string['dmlexceptiononinstall'] = '<p> Ένα σφάλμα βάσης δεδομένων έχει συμβεί [{$a->errorcode}]. <br /> {$a->debuginfo} </p>';
