...
$string['clialreadyconfigured'] = 'Il file config.php è già presente, per favore utilizza admin/cli/install_database.php se desideri installare Totara su questo sito.';
...
$string['pathssubdataroot'] = 'E\' necessario specificare una cartella dove Totara inserirà i file caricati dagli utenti. Il web server (in genere \'nobody\' o \'apache\') DEVE avere i permessi di lettura e di scrittura su questa cartella. In aggiunta, la cartella dei dati NON DEVE essere direttamente accessibile via web. Se la Cartella dei dati non esiste, lo script di installazione tenterà di crearla.';
$string['pathssubdirroot'] = 'Percorso assoluto della cartella di installazione di Totara.';
$string['pathssubwwwroot'] = 'Indirizzo web per accedere a Totara. Non è possibile accedere alla stessa installazione Totara usando più di un indirizzi web. Se il tuo sito usa più indirizzi web, devi configurare dei re-indirizzamenti permanenti per tutti gli altri indirizzi.
...
$string['phpversionhelp'] = '<p>Totara necessita come minimo della versione 5.6.5 del PHP. (La versione 7.0.x ha alcuni limiti nell\'engine)</p>
