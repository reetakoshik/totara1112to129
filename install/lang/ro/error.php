...
$string['cannotcreatedboninstall'] = '<p>Nu a putut fi creata baza de date.</p>
<p>Baza de date specifica nu exista si utilizatorul dat nu are permisiunea de a crea baza de date.</p>
<p>Administratorul site-ului ar trebui sa verifice configuratia bazei de date.</p>';
...
$string['dmlexceptiononinstall'] = '<p>A aparut o eroare la baza de date.[{$a->errorcode}].<br />{$a->debuginfo}</p>';
