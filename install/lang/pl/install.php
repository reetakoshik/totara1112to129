...
$string['clialreadyconfigured'] = 'Plik config.php już istnieje. Użyj admin/cli/install_database.php jeśli chcesz zainstalować Totara dla tej strony.';
$string['clialreadyinstalled'] = 'Plik config.php już istnieje. Użyj admin/cli/install_database.php jeśli chcesz uaktualnić witrynę.';
...
$string['welcomep40'] = 'Pakiet zawiera także <strong>Totara {$a->moodlerelease} ({$a->moodleversion})</strong>.';
