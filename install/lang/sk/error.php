...
$string['cannotcreatedboninstall'] = '<p>Nedá sa vytvoriť databáza.</p> <p>Určená databáza neexistuje a používateľ nemá oprávnenie na jej vytvorenie.</p> <p>Administrátor portálu by mal overiť konfiguráciu databázy.</p>';
...
$string['dmlexceptiononinstall'] = '<p>Objavila sa chyba databázy [{$a->errorcode}].<br />{$a->debuginfo}</p>';
