...
$plugin->version  = 2016092200;   // The (date) version of this module + 2 extra digital for daily versions
...
$plugin->requires = 2015050500;  // Requires this Moodle version - at least 2.0
$plugin->cron     = 0;
$plugin->release = '1.0 (Build: 20160602)';
$plugin->maturity = MATURITY_STABLE;
$plugin->component = 'local_zapier';