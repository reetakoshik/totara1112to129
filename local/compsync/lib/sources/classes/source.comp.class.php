...
abstract class totara_sync_source_comp extends totara_sync_source {
    ...
    function __construct() {
        ...
        $cfields = $DB->get_records('comp_type_info_field');
    ...
    function prepare_temp_table($clone = false) {
        ...
        $table->add_field('aggregationmethod', XMLDB_TYPE_INTEGER, '10', null);
        $table->add_field('proficiencyexpected', XMLDB_TYPE_INTEGER, '10', null);
        $table->add_field('evidencecount', XMLDB_TYPE_INTEGER, '10', null);
