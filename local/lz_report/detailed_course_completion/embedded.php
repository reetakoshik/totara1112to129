...
$PAGE->set_url('/local/lz_report/detailed_course_completion/embedded.php', ['courseid' => $courseid]);
$PAGE->set_pagelayout('noblocks');
buildBreadcrumbs($course);

require_capability(VIEW_LZ_REPORT_CAPABILITY, $context);

$strheading = get_string('sourcetitle', 'rb_source_detailed_course_completion') . ' ' . $course->shortname;

$shortname = 'detailed_course_completion';
