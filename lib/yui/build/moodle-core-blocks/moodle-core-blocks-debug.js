...
MANAGER.prototype = {
    ...
    /**
     * overwrites M.core.dragdrop.global_drop_over when dragging is dragged over a drop target.
     * @method drop_over
     * @param {Event} e
     */
    global_drop_over: function(e) {
        ...
        if (drop.hasClass(this.samenodeclass)) {
            ...
            // If drop target is admin block, move above
            if (drop.on('.' + CSS.BLOCKADMINBLOCK)) {
                where = "before";
            }
