...
class Header extends Base
{
    ...
    public function render()
    {
        ...
        $activevideomessage = $DB->get_records('config_plugins', ['plugin' => 'local_videomessage']);
        // echo "<pre>local_videomessage";
        // print_r($activevideomessage); 
...
//                ] : false,
                ...
                'tour' => [
                 ...
                 'videomessage' => [
                    'enabled' => !empty($activevideomessage) ? true : false,
