...
use core_course\totara_catalog\course\dataformatter\format as format_dataformatter;
use totara_catalog\dataformatter\formatter;
use totara_catalog\dataholder;
use totara_catalog\dataholder_factory;

class format extends dataholder_factory {
    ...
    public static function get_dataholders(): array {
        return [
            new dataholder(
                ...
                [
                    formatter::TYPE_PLACEHOLDER_TEXT => new format_dataformatter(
                        'base.format'
                    ),
                ]
            )
