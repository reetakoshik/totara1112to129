...
/**
 * Sessions user data item, responsible for purging, exporting and counting user modified versions for collaborative wiki.
 *
 * @package mod_wiki\userdata
 */
class collaborative_versions extends item {
    /**
    ...
    protected static function export(target_user $user, \context $context) {
        $export = new export();
        $export->data = (new helpers\collaborative_versions($user, $context))->export();
        return $export;
    }
    ...
    protected static function count(target_user $user, context $context) {
        return (new helpers\collaborative_versions($user, $context))->count();
    }
}