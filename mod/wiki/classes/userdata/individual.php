...
/**
 * Sessions user data item, responsible for purging, exporting and counting individual wikis.
 *
 * @package mod_wiki\userdata
 */
class individual extends item {
    /**
    ...
    protected static function purge(target_user $user, context $context) {
        (new helpers\individual($user, $context))->purge();
    ...
    protected static function export(target_user $user, \context $context) {
        $export = new export();
        [$export->data, $export->files] = (new helpers\individual($user, $context))->export();
        return $export;
    }
    ...
    protected static function count(target_user $user, context $context) {
        return (new helpers\individual($user, $context))->count();
    }
}