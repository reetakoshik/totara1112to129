...
trait checkbox_report_trait {

    /**
     * Adds checkbox custom field table to the $joinlist array
     *
    ...
    /**
     * Adds checkbox custom field to the $columnoptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     * @param array     $columnoptions
     */
    protected function add_totara_customfield_checkbox_columns(\stdClass $cf_info, array &$columnoptions) {
        global $DB;
    ...
    /**
     * Adds checkbox custom field to the $filteroptions array
     *
     * @param \stdClass $cf_info Object containing information about this custom field
     ...
     */
    protected function add_totara_customfield_checkbox_filters(\stdClass $cf_info, array &$filteroptions) {
        $name = isset($cf_info->fullname) ? $cf_info->fullname : $cf_info->name;
