 ...
 */
class scheduled_report_created extends \core\event\base {
    /**
    ...
    public static function get_name() {
        return get_string('eventscheduledreportcreated', 'totara_reportbuilder');
    }
    ...
    public function get_description() {
        ...
        $owner = $this->other['owner'];

        $msg = sprintf(
            "The user with id '%s' created a scheduled report (scheduleid='%d', reportid='%s')",
            $owner, $this->objectid, $report
        );
        return $msg;
    }
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call scheduled_report_created::create() directly, use scheduled_report_created::create_from_schedule() instead.');
        }
