...
/**
 * Competency custom field management class.
 *
 * @package totara_hierarchy
 * @category totara_customfield
 */
class competency implements \totara_customfield\area {
    ...
    public static function can_view($instanceorid) {
        ...
        return (bool)$perms['canviewitems'];
    }
    ...
    public static function pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, $options = array()) {
        ...
        $competencyid = $DB->get_field('comp_type_info_data', 'competencyid', $conditions, MUST_EXIST);
        $allowaccess = self::can_view($competencyid);
