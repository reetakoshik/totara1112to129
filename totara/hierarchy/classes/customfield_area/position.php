...
/**
 * Position custom field management class.
 *
 * @package totara_hierarchy
 * @category totara_customfield
 */
class position implements \totara_customfield\area {
    ...
    public static function pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, $options = array()) {
        ...
        $positionid = $DB->get_field('pos_type_info_data', 'positionid', $conditions, MUST_EXIST);
        $allowaccess = self::can_view($positionid);
