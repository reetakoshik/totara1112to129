...
class rb_source_orgcertifstatus extends rb_base_source {
    ...
    function __construct() {
        ...
        $this->sourcetitle = get_string('sourcetitle', 'rb_source_orgcertifstatus');
    ...
    protected function define_columnoptions() {
        ...
        new rb_column_option(
                'org',
                'idnumber',
                get_string('idnumber', 'rb_source_orgcertifstatus'),
                "base.idnumber",
            ...
            new rb_column_option(
                'org',
                'fullname',
                get_string('name', 'rb_source_orgcertifstatus'),
                "base.fullname",
            ...
            new rb_column_option(
                'org',
                'shortname',
                get_string('shortname', 'rb_source_orgcertifstatus'),
                "base.shortname",
                array('dbdatatype' => 'char',
                      'outputformat' => 'text')
            ),
            new rb_column_option(
                'org',
                'description',
                get_string('description', 'rb_source_orgcertifstatus'),
                "base.description",
            ...
            new rb_column_option(
                'org',
                'orgtypeid',
                get_string('type', 'rb_source_orgcertifstatus'),
                'orgtype.id',
                array(
                    'joins' => 'orgtype',
                    'hidden' => true,
            ...
            new rb_column_option(
                'org',
                'orgtypeidnumber',
                get_string('typeidnumber', 'rb_source_orgcertifstatus'),
                'orgtype.idnumber',
                array('joins' => 'orgtype',
                    'displayfunc' => 'plaintext',
                    'dbdatatype' => 'char',
            ...
            new rb_column_option(
                'org',
                'framework',
                get_string('framework', 'rb_source_orgcertifstatus'),
                "framework.fullname",
            ...
            new rb_column_option(
                'org',
                'frameworkidnumber',
                get_string('frameworkidnumber', 'rb_source_orgcertifstatus'),
                "framework.idnumber",
                array('joins' => 'framework',
                    'displayfunc' => 'plaintext',
                    'dbdatatype' => 'char',
            ...
            new rb_column_option(
                'org',
                'visible',
                get_string('visible', 'rb_source_orgcertifstatus'),
                'base.visible',
            ...
            new rb_column_option(
                'org',
                'parentidnumber',
                get_string('parentidnumber', 'rb_source_orgcertifstatus'),
                'parent.idnumber',
                array('joins' => 'parent',
                      'displayfunc' => 'plaintext',
                      'dbdatatype' => 'char',
            ...
            new rb_column_option(
                'org',
                'parentfullname',
                get_string('parentfullname', 'rb_source_orgcertifstatus'),
                'parent.fullname',
                array('joins' => 'parent',
                      'dbdatatype' => 'char',
                      'outputformat' => 'text')
            ...
            new rb_column_option(
                'org',
                'comps',
                get_string('competencies', 'rb_source_orgcertifstatus'),
                'comps.list',
                array('joins' => 'comps',
                      'dbdatatype' => 'char',
                      'outputformat' => 'text')
            ...
            new rb_column_option(
                'org',
                'timecreated',
                get_string('timecreated', 'rb_source_orgcertifstatus'),
                'base.timecreated',
            ...
            new rb_column_option(
                'org',
                'timemodified',
                get_string('timemodified', 'rb_source_orgcertifstatus'),
                'base.timemodified',
                array('displayfunc' => 'nice_date', 'dbdatatype' => 'timestamp')
            ),
            // A count of all members of this organisation.
            new rb_column_option(
                'org',
                'membercount',
                get_string('membercount', 'rb_source_orgcertifstatus'),
            ...
            new rb_column_option(
                ...
                get_string('membercountcumulative', 'rb_source_orgcertifstatus'),
            ...
            new rb_column_option(
                'org',
                'parent',
                'ORG Certif Compliant',
                "null",
                array(
                    'displayfunc' => 'iscertifiedorg',
                    'defaultheading' => 'ORG Certif Compliant',
                    'dbdatatype' => 'char',
                    'outputformat' => 'text'
                )
            ),
            ...
            new rb_column_option(
                'org',
                'parentnoncomp',
                'ORG Certif Non-Compliant',
                "null",
                array(
                    'displayfunc' => 'iscertifiedorgnoncomp',
                    'defaultheading' => 'ORG Non-Compliant',
                    'dbdatatype' => 'char',
                    'outputformat' => 'text'
                )
            ),
            ...
            new rb_column_option(
                ...
                "null",
                array(
                    'displayfunc' => 'orgtarget',
                    'defaultheading' => 'ORG Target',
                    'dbdatatype' => 'char',
                    'outputformat' => 'text'
                )
            ),
            ...
            new rb_column_option(
                ...
                "null",
                array(
                    'displayfunc' => 'orgidname',
                    'defaultheading' => 'ORG ID Name',
                    'dbdatatype' => 'char',
                    'outputformat' => 'text'
                )
            ),
    ...
    protected function define_filteroptions() {
        $filteroptions = array(
            new rb_filter_option(
                'org',              // type
                'idnumber',         // value
                get_string('idnumber', 'rb_source_orgcertifstatus'), // label
                'text'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'fullname',         // value
                get_string('name', 'rb_source_orgcertifstatus'), // label
                'text'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'shortname',        // value
                get_string('shortname', 'rb_source_orgcertifstatus'), // label
                'text'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'description',      // value
                get_string('description', 'rb_source_orgcertifstatus'), // label
                'text'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'parentidnumber',   // value
                get_string('parentidnumber', 'rb_source_orgcertifstatus'), // label
                'text'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'parentfullname',   // value
                get_string('parentfullname', 'rb_source_orgcertifstatus'), // label
                'text'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'timecreated',      // value
                get_string('timecreated', 'rb_source_orgcertifstatus'), // label
                'date'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'timemodified',     // value
                get_string('timemodified', 'rb_source_orgcertifstatus'), // label
                'date'              // filtertype
            ),
            new rb_filter_option(
                'org',              // type
                'orgtypeid',        // value
                get_string('type', 'rb_source_orgcertifstatus'), // label
                'select',           // filtertype
                array(
                    'selectfunc' => 'orgtypes',
            ...
            new rb_filter_option(
                'org',              // type
                'visible',          // value
                get_string('visible', 'rb_source_orgcertifstatus'), // label
                'select',           // filtertype
                array(
...
} // end of rb_source_orgcertifstatus class
