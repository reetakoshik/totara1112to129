@totara @totara_form
Feature: Totara form onchange ajaxsubmit client action test suite
  ...
  Background:
    ...
    When I select "Onchange ajaxsubmit client action test [totara_form\form\testform\clientaction_onchange_ajaxsubmit]" from the "Test form" singleselect
    Then I should see "Form: Onchange ajaxsubmit client action test"
