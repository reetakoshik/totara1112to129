@totara @totara_form
Feature: Totara form onchange submit client action test suite
  ...
  Background:
    ...
    When I select "Onchange submit client action test [totara_form\form\testform\clientaction_onchange_submit]" from the "Test form" singleselect
    Then I should see "Form: Onchange submit client action test"
