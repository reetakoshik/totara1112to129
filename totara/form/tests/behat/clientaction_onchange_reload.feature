@totara @totara_form
Feature: Totara form onchange reload client action test suite
  ...
  Background:
    ...
    When I select "Onchange reload client action test [totara_form\form\testform\clientaction_onchange_reload]" from the "Test form" singleselect
    Then I should see "Form: Onchange reload client action test"
