 ...
 * @package totara_form
 */
class clientaction_onchange_ajaxsubmit extends form {
    ...
    public static function get_form_test_name() {
        return 'Onchange ajaxsubmit client action test';
    }
    ...
    public static function get_form_controller() {
        return new clientaction_onchange_ajaxsubmit_controller();
    }
    ...
    public function definition() {
        ...
        if (!empty($checkbox->get_data()['checkbox_2'])) {
            $this->model->add(new static_html('checkbox_2_relaoded', 'Checkbox 2 submit via ajax', 'Success!'));
        }
