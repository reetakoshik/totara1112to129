...
/**
 * This is the purge and export user data item for participation in other users' appraisals.
 */
class participation extends item {
    ...
    protected static function purge(target_user $user, \context $context) {
        ...
        \appraisal::unassign_user_roles($user->id, false);
    ...
    protected static function export(target_user $user, \context $context) {
        ...
        $params = ['userid' => $user->id, 'rolelearner' => \appraisal::ROLE_LEARNER];
        $export->data = $DB->get_records_select('appraisal_role_assignment', $select, $params);
    ...
    protected static function count(target_user $user, \context $context) {
        ...
        $select = "userid = :userid AND appraisalrole <> :rolelearner";
        $params = ['userid' => $user->id, 'rolelearner' => \appraisal::ROLE_LEARNER];
        $roleassignments = $DB->count_records_select('appraisal_role_assignment', $select, $params);
