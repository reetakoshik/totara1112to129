...
class appraisal_role_stage_completed extends base {
    ...
    public static function get_name() {
        return get_string('eventrolestagecompleted', 'totara_appraisal');
    }
    ...
    public function get_description() {
        return "The appraisal stage {$this->other['stageid']} for learner {$this->relateduserid} in appraisal {$this->objectid} was completed by user {$this->userid} in role {$this->other['role']}";
    }
