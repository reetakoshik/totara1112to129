...
class appraisal_stage_completed extends base {
    ...
    public function get_description() {
        return "The appraisal stage {$this->other['stageid']} for learner {$this->relateduserid} in appraisal {$this->objectid} was completed by user {$this->userid}";
    }
