...
/**
 * Display class intended for competency status history link
 *
 * @author Simon Player <simon.player@totaralearning.com>
 * @package totara_plan
 */
class plan_competency_status_history_link extends base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        ...
        $url = new \moodle_url('/totara/hierarchy/prefix/competency/statushistoryreport.php',
            array('userid' => $value, 'competencyid' => $extrafields->competencyid));
