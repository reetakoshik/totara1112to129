...
/**
 * Display class intended for objective status
 *
 * @author Simon Player <simon.player@totaralearning.com>
 * @package totara_plan
 */
class plan_objective_status extends base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        ...
        if ($approved == DP_APPROVAL_UNAPPROVED ||
            ...
            $content .= html_writer::empty_tag('br') . plan_item_status::display($approved, $format, $row, $column, $report);
        }
        return $content;
    }
