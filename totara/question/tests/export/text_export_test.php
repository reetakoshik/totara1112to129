 ...
 * @Class totara_question_text_export_testcase
 *
 * To test, run this from the command line from the $CFG->dirroot.
 * vendor/bin/phpunit --verbose totara_question_text_export_testcase totara/question/tests/export/text_export_test.php
 */
class totara_question_text_export_testcase extends advanced_testcase {

    public function test_export_data_no_answer() {
        $exporter = \totara_question\local\export_helper::create('appraisal', 'xyz', 'text');
