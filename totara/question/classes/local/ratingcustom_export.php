 ...
 * @package totara_question
 */
class ratingcustom_export extends export_helper {
     ...
     * @return mixed array|string - The none string, or an array containing answer and score.
     */
    public function export_data(\stdClass $answerrow, \stdClass $question) {
        ...
        return ['answer' => $data->name, 'score' => $data->score];
    }
}
