...
use totara_certification\totara_catalog\certification\dataformatter\progressbar as certification_progressbar_formatter;
    ...
    public static function get_dataholders(): array {
        ...
        return [
            new dataholder(
                ...
                'notused',
                [
                    formatter::TYPE_PLACEHOLDER_PROGRESS => new certification_progressbar_formatter(
