...
use totara_program\totara_catalog\program\observer\category_updated as program_category_updated;

class category_updated extends program_category_updated {

    /**
     * Override parent class to work with certifications.
     */
    protected function get_object_condition(): string {
        return "prog.certifid IS NOT NULL";
    }
