...
$functions = [
    ...
    'tool_policy_get_related_pcourses' => [
        'classname'     => 'tool_policy\external',
        'methodname'    => 'get_related_pcourses',
        'classpath'     => '',
        'description'   => 'Fetch the details of a policy and courses',
        'type'          => 'read',
        'capabilities'  => '',
        'ajax'          => true,
        'loginrequired' => false,
    ],
    'tool_policy_get_related_policy' => [
        'classname'     => 'tool_policy\external',
        'methodname'    => 'get_related_policy',
        'classpath'     => '',
        'description'   => 'Fetch the details of a policy',
        'type'          => 'read',
        'capabilities'  => '',
        'ajax'          => true,
        'loginrequired' => false,
    ],
    'tool_policy_get_related_audiences' => [
        'classname'     => 'tool_policy\external',
        'methodname'    => 'get_related_audiences',
        'classpath'     => '',
        'description'   => 'Fetch the details of a policy',
        'type'          => 'read',
        'capabilities'  => '',
