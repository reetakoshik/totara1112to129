  ...
  return {
        init: function() {
            ...
            var wwwroot = M.cfg.wwwroot;
                ...
                ajax.call([{
                    methodname: 'tool_policy_get_related_policy',
                    args: {},
                        ...
                        var res3 = res2.policies; 
                        var lastEl = res3[res3.length-1];
                        //console.log(lastEl.title);
                      
                        
            var trigger = $('#create-modal-policy');
            //trigger.click(function() {
                
                ModalFactory.create({
                  type: ModalFactory.types.SAVE_CANCEL,
                  title: lastEl.title,
                  body: Templates.render('tool_policy/modal_related_policy',res2, {}),
                }, trigger)
                .then(function(modal) {
