...
$string['pluginname'] = 'Ekko Policies';
...
$string['policy:policyowner'] = 'Policy owner';
...
$string['policydoccontent'] = 'Policy Statement';
...
$string['policydocrevision'] = 'Last Modified';
...
$string['policydoctype10'] = 'Safety';
$string['policydoctype11'] = 'Finance';
$string['policydoctype12'] = 'HR';
$string['policydoctype13'] = 'ISO';
$string['policydoctype14'] = 'Production';
$string['policydoctype15'] = 'Procedure';
...
$string['policyrevision'] = 'Revision';
$string['policylanguage'] = 'Language';
$string['policylastmodify'] = 'Last Modified';
$string['policycompletion'] ='Completion';
$string['policyaction'] ='Action';
$string['policytemplatemanager'] ='Template Manager';
$string['policycommitteesetup'] ='Committee Setup';
$string['policyfilterby'] ='Filter by';
$string['policydate'] = 'Date';
$string['policystatus']='Status';
$string['policytype']='Type';
$string['policylang']='language';
$string['policycomp']='Completion';

$string['policyfilterstatus']='Status';
$string['generalcomment']='General Comment';
$string['relatedpolicy']='Related Policies';
$string['relatedcourse']='Related Courses';
$string['relatedresources']='Related Resources';
$string['parentpolicy']='Parent Policy';
$string['changelog']='Change Log';
//$string['descriptionofassign']='Assign to change from {$a} to {$b}';
$string['messageprovider:sendpolicynotification'] = 'Notification of Policy';
$string['policy:emailnotifypolicy'] = 'Send Policy Notification';
$string['relatedaudience'] = 'Related Audiences';
$string['subject'] = 'Subject';
$string['message'] = 'Message';
$string['sendmanager'] = 'Enable Send notification to manager';
$string['sendmanagerinfo'] = 'If enable message notification also send to policy manager';
$string['sendmanagerlabel'] = 'Send Notice To Manager';
$string['managersubject'] = 'Manager Subject';
$string['managermessage'] = 'Manager Message';
$string['updatetoolpolicytask'] = 'Update Admin Tool Policy';
$string['policyowner'] = 'Policy Owner';
$string['policyownerdescription'] = 'policyowner can manage all task of policy';
$string['policyeditor'] = 'Policy Editor';
$string['createpolicydocument'] = 'Create Policy';
$string['policyeditordescription'] = 'policyeditor can manage all task of policy except create delete';
$string['clone'] = 'Clone';
...
$string['policymessages'] = 'Policy Messages';
$string['browse'] = 'Browse';
$string['search'] = 'Search';
$string['itemstoadd'] = 'Items to add';
$string['searchpolicies'] = 'Search Policies';
$string['searchcourses'] = 'Search Courses';
$string['searchaudiences'] = 'Search Audiences';
$string['policyexpiary'] = 'Select Policy Expiary Date';
$string['by'] = 'By';
$string['changefrom'] = 'change from';
$string['to'] = 'To';
$string['addcourses'] = 'Add Courses';
$string['addpolicies'] = 'Add Policies';
$string['addaudiences'] = 'Add Audiences';
