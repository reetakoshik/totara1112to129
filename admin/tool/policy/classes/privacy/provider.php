    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table(
            ...
            [
                ...
                /*'comment' => 'privacy:metadata:versions:comment',
                'commentformat' => 'privacy:metadata:versions:commentformat',*/
            ],
            'privacy:metadata:versions'
        );

        $collection->add_subsystem_link('core_files', [], 'privacy:metadata:subsystem:corefiles');
       //echo "<pre>"; print_r($collection); echo "</pre>"; die('here 12345');
        return $collection;
    }
    ...
    protected static function export_policy_agreements_for_context(\context_user $context) {
        ...
        $agreementsql = "
            SELECT
                ...
                v.summary, v.summaryformat, v.parentpolicy,
        ...
        foreach ($agreements as $agreement) {
            ...
            /*$comment = writer::with_context($context)->rewrite_pluginfile_urls(
                $subcontext,
                'tool_policy',
                'policydocumentcomment',
                $agreement->versionid,
                $agreement->comment
            );*/
            ...
            $agreementcontent = (object) [
                ...
                /*'comment' => format_text($comment, $agreement->commentformat),*/
            ];
