...
/**
 * Display class intended for related educational level
 *
 * @author Simon Player <simon.player@totaralearning.com>
 * @package tool_log
 */
class log_educational_level extends base {
    ...
    public static function display($value, $format, \stdClass $row, \rb_column $column, \reportbuilder $report) {
        ...
        return get_string('unrecognized', 'rb_source_site_logstore', $value);
    }
