...
// Output form error message if needed.
if (!empty($err)) {
    echo $OUTPUT->notification(get_string('errorsettingschange', 'auth'), 'notifyproblem');
}

// choose an authentication method
echo "<form id=\"authmenu\" method=\"post\" action=\"auth_config.php\" class=\"mform\">\n";
echo "<div>\n";
