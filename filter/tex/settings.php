...
if ($ADMIN->fulltree) {
    ...
    $allowedcolourchars = '/^#?[a-zA-Z0-9]*$/'; // Colour could be hex (e.g. #FF0000) or a word for a colour (e.g. 'red').
    $items[] = new admin_setting_configtext('filter_tex/latexbackground', get_string('backgroundcolour', 'admin'), '', '#FFFFFF', $allowedcolourchars);
